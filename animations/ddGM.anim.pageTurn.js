/* /////////////////////////////////////////////////////
 * Page Turn Animation for ddGM
 * v 1.0 :: 2012-09-21
//////////////////////////////////////////////////////*/
(function(){
	var animName = 'pageTurn',
	...
	animation = {
		...
		animate : function(dfd, animComplete, newItem, prevItem, dir) {
			...
			// initialize canvas
			dd.obj.stageWrap.wrap('<canvas id="'+dd.id+'-pageTurnCanvas" style="position:absolute;z-index:'+dd.layers.stage+'"/>').ready(function(){
			
				// save references
				dd.obj.pageTurnCanvas = dd.gal.find('#'+dd.id+'-pageTurnCanvas');
				dd.obj.pageTurnContext = dd.obj.pageTurnCanvas[0].getContext( "2d" );
				
				// save dimensions
				dd.states.pageTurn = {
					padding: 60,
					width: dd.obj.stage.width()
				
				// set canvas dimensions
				dd.obj.pageTurnCanvas.css({
					width: dd.obj.stage.width()+(padding*2),
					height: dd.gal.height()+(padding*2),
					left: padding*-1,
					top: padding*-1
				});
				...
				// 
				dd.obj.pageTurnContext.clearRect( 0, 0, dd.obj.pageTurnCanvas.width, dd.obj.pageTurnCanvas.height );
